const customPrice = (email, name, company, phone, message) => `
...
<title>GoCustomer Custom Price</title>
      ...
      <td align="center" valign="top"><table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table" style="width:650px; table-layout:fixed;">
          <tr>
            <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td align="center" valign="top"><a href="https://gocustomer.ai/" target="_blank" style="text-decoration:none;"><img src="https://app.gocustomer.ai/static/brand/logo_single.png" width="82" height="45" alt="GoCustomer" border="0" style="display:block; font-family:Arial, sans-serif; font-size:18px; line-height:25px; text-align:center; color:#5a29a7; font-weight:bold; max-width:70px;" class="em_w150" /></a></td>
              </tr>
              <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="em_full_wrap" align="center" bgcolor="#efefef">
            ...
            <td align="center" valign="top" style="padding:0 25px; background-color:#ffffff;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td class="em_grey" align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 26px; color:#434343;">
                    <h2 style="text-align:center;"> GoCustomer Custom Pricing Plan Inquiry</h2>
                    <br />
                  <div style="width:100%">
  ...
  <table style="width:70%;margin:auto; border: 1px solid black;
    border-collapse: collapse;">
    <tr>
      <th style="text-align:left;padding:10px; border: 1px solid black;
    border-collapse: collapse;">Name</th>
       <td style="text-align:left;padding:10px; border: 1px solid black;
    border-collapse: collapse;">${name}</td>
    </tr>
     <tr>
        <th style="text-align:left;padding:10px; border: 1px solid black;
    ...
    border-collapse: collapse;">Phone</th>
        <td style="text-align:left;padding:10px; border: 1px solid black;
    border-collapse: collapse;">${phone}</td>
    </tr>
     <tr>
        <th style="text-align:left;padding:10px; border: 1px solid black;
    border-collapse: collapse;">Company</th>
          <td style="text-align:left;padding:10px; border: 1px solid black;
    border-collapse: collapse;">${company}</td>
    </tr>     
     <tr>
         <th style="text-align:left;padding:10px; border: 1px solid black;
    border-collapse: collapse;">Message</th>
      <td style="text-align:left;padding:10px; border: 1px solid black;
    border-collapse: collapse;">${message}</td>
    </tr> 
  </table>
  </div>
                  </td>
            ...
            <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      <td width="30" style="width:30px;" align="center" valign="middle"><a href="https://www.facebook.com/gocustomerai" target="_blank" style="text-decoration:none;"><img src="https://img.icons8.com/fluency/96/000000/facebook-new.png" width="30" height="30" alt="Fb" border="0" style="display:block; font-family:Arial, sans-serif; font-size:18px; line-height:25px; text-align:center; color:#000000; font-weight:bold; max-width:30px;" /></a></td>
                      <td width="12" style="width:12px;">&nbsp;</td>
                      <td width="30" style="width:30px;" align="center" valign="middle"><a href="https://twitter.com/gocustomerai" target="_blank" style="text-decoration:none;"><img src="https://img.icons8.com/color/96/000000/twitter--v1.png" width="30" height="30" alt="Tw" border="0" style="display:block; font-family:Arial, sans-serif; font-size:14px; line-height:25px; text-align:center; color:#000000; font-weight:bold; max-width:30px;" /></a></td>
                      <td width="12" style="width:12px;">&nbsp;</td>
                      <td width="30" style="width:30px;" align="center" valign="middle"><a href="https://www.instagram.com/gocustomer" target="_blank" style="text-decoration:none;"><img src="https://img.icons8.com/fluency/96/000000/instagram-new.png" width="30" height="30" alt="Insta" border="0" style="display:block; font-family:Arial, sans-serif; font-size:14px; line-height:25px; text-align:center; color:#000000; font-weight:bold; max-width:30px;" /></a></td>
                    </tr>
                  </table>
                 </td>
              </tr>
                ...
                <td align="center" valign="top" style="font-size:0px; line-height:0px;"><table border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td class="em_grey em_font_11" align="left" valign="middle" style="font-family: Arial, sans-serif; font-size: 13px; line-height: 15px; color:#434343;">
                        <a href="mailto:info@gocustomer.ai" style="text-decoration:underline; color:#434343;">info@gocustomer.ai</a>
                    </td>
                  </tr>
                </table>
                </td>
              ...
              <tr>
                <td height="7" style="height: 7px !important;font-size: 7px !important;line-height: 7px !important;">&nbsp;</td>
              </tr>
               <tr>
                <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td width="7" style="width:7px; font-size:0px; line-height:0px;" class="em_w5">&nbsp;</td>
                    <td class="em_grey em_font_11" align="left" valign="middle" style="font-family: Arial, sans-serif; font-size: 13px; line-height: 15px; color:#434343; text-align: center;">GoCustomer &bull; 325 N. St. Paul Street, Suite 3100, Dallas, Texas, 75201, USA
</td>
                  </tr>
                </table>
                </td>
